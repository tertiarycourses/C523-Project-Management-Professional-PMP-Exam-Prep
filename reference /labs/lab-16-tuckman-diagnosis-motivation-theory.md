...
| WSQ learning outcome | LO3 - Lead and develop project teams to sustain performance |
| Duration | 75 minutes |
...
THURSDAY
  ...
  sprint running. She is the only person rated 5 on PDPA/SSG domain in the
...
STRUCTURAL CAUSES - these are the PM's to fix, not the team's
  ...
  C-3  Farah is a single point of failure on PDPA/SSG at 2 points of capacity
