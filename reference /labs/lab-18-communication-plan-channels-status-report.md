...
COMPLIANCE
  ...
  DPO. 3 outstanding: consent withdrawal flow, SSG data retention
...
4  COMPLIANCE
   ...
   Outstanding: consent withdrawal flow; SSG data retention schedule;
...
Sprint goal: consent withdrawal flow demonstrable in staging.
  ...
  IN PROGRESS
    ...
    CTP-250  SSG retention schedule config      Farah       2 pts
