...
| IN-5 | SSG funding data capture: NRIC-linked attendance records with 7-year retention |
...
R-4  Personal data is collected with valid consent and used only for the
     purpose stated.
R-5  Attendance records support SSG funding claims without manual rework.
...
| A-06 | SSG subsidy tiers will not change before launch | Announcement expected Q3, after launch | Fee display rework | Monitored per Lab 02 cadence | BA |
