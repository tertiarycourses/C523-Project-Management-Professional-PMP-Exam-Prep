...
The project will modernise course registration and learner communications.
  ...
  Constraint         A regulatory compliance review (PDPA + SSG funding data)
...
| --- | --- | --- |
| Course title | Project Management Professional (PMP) 35 PDU Training | |
| Provider | Tertiary Infotech Academy Pte Ltd (UEN 201200696W) | |
| Course reference | TGS-2024045797 | |
...
- Your PDU log names the provider, the course reference TGS-2024045797, and 35 contact hours.
