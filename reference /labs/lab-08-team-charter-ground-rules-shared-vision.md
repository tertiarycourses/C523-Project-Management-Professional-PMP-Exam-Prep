...
| WSQ learning outcome | LO2 - Plan and organise project resources and team structures for delivery |
| Duration | 75 minutes |
...
DRAFT 1 (too long, and it is a scope statement, not a vision)
  "We will deliver a responsive course registration portal with automated
   learner communications, PDPA-compliant consent capture, SSG funding data
...
| T-7 | Farah Ismail | Business analyst | Requirements, PDPA and SSG domain, traceability | 2 | Overloaded - see the Step 7 capacity note |
...
| PDPA / SSG domain | 1 | 1 | 1 | 2 | 1 | 2 | 5 | 1 | 3 | **RISK - one person** |
...
| PDPA / SSG - only Farah (T-7) at 5, and she carries only 2 pts because she is spread across 3 workstreams | Compliance requirements stall; gate G3 at risk | Grace Tay shadows Farah on consent wording; capped SME hours from S-06 admin staff agreed per Lab 06 assumption A-07 | PM | Week 2 |
